<template>
  <div class="findfont relative font-body bg-white">
      <!-- Navbar -->
    ...
    <!-- Nav Menu -->
        <div class="nav-menu hidden large:block" id="nMenu">
            <ul class="large:flex large:flex-row large:items-center large:text-xl text-black" id="nLinks">
                <li class="large:mx-6"><nuxt-link to="/#projects"><span><your-hover-class>Projects</your-hover-class></span></nuxt-link></li>
                ...
                <li class="large:mx-6"><nuxt-link to="/#contact"><span><your-hover-class>Contact</your-hover-class></span></nuxt-link></li>
            </ul>
        </div> 
  </div>
    </nav>
