<template>
  ...
  >
    ...
    >
            ...
            >
              ...
              <div class="mb-7 tab:mb-10 large:mb-9">
                ...
                <p
                  class="text-grey3 mt-2 phone:text-lg tab:mt-5 tab:text-xl large:text-xl large:mt-4"
                >
                  A design for a travel and booking website.
                </p>
              </div>
              <!-- Technologies -->
              <div>
            ...
            >
              ...
              <div class="mb-7 tab:mb-10 large:mb-9">
                ...
                <p
                  class="text-grey3 mt-2 phone:text-lg tab:mt-5 tab:text-xl large:text-xl large:mt-4"
                >
                  A website design for selling food online.
                </p>
              </div>
              <!-- Technologies -->
              <div>
      ...
      <!-- Ear1 -->
      <div
        class="relative bg-ear1 rounded-md grid justify-center items-center row-start-22 row-end-29 small:row-start-25 small:row-end-33 tab:row-start-31 tab:row-end-41 large:col-start-2 large:col-end-3 large:row-start-8 large:row-end-13 xlarge:row-start-9 xlarge:row-end-15"
      >
        <img
          class="w-24 small:w-xt3 phone:w-ff tab:w-36 xlarge:w-44"
